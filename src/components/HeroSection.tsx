      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-4 font-medium opacity-90">
            Робимо складне простим — чат-боти, CRM, AI, автоматизація та IoT
          </p>
          
          {/* Mission statement */}
          <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto opacity-80 font-light">
            Ми — українська команда, що допомагає бізнесу впровадити системність і цифрову свободу через розумні технології. 
