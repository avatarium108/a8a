          ...
          <div className="relative mb-8">
            ...
            <h1 className="relative text-4xl md:text-6xl lg:text-7xl font-black mb-2 leading-tight">
              ...
              <div className="relative inline-block">
                <span className="absolute left-[-30rem] top-0 font-mono text-sm text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-200 animate-fade-in">
                  para.tech
                </span>
