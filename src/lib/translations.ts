...
export const translations: Record<SupportedLocale, TranslationContent> = {
  ua: {
    ...
    services: {
      title: "Що ми робимо:",
      subtitle: "Створюємо цифрові рішення для бізнесу, медицини та волонтерства — від сайтів до AI-агентів",
      calculator: {
    ...
    team: {
      ...
      points: {
        ...
        location: { title: "🇺🇦 Команда з України", description: "🏛️ Київ, 🦁 Львів, 🌾 Рівне, ⚡ Дніпро, ⚔️ Запоріжжя — ми тут, поруч, і розуміємо ваш контекст як ніхто інший." }
      },
    ...
    footer: {
      description: "Українська команда з автоматизації бізнесу. Створюємо чат-боти, CRM, AI-рішення для компаній, які будують сильну Україну.",
      services: {
        title: "Послуги",
      ...
      copyright: "© 2025 8a88a.io. Всі права захищені. Слава Україні! 🇺🇦",
      links: {
